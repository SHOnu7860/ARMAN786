...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const botAdminID = '61575699637747'; // Bot Admin UID
  const femaleSpecialUIDs = ['100086169630526', '100086169630526',
'100082052205053']; // Replace with actual UIDs
  ...
  const replies = {
    "kamin": {
      "MALE": ["तु है कमिना मैं तो बोट हूं।🥺", " तु डबल कमिना 😐🤐😑", " तु है सबसे बड़ा कमिना", " तु है कमिना मैं तो शिवा हूं।😐🤐"],
...
"tharki": {
"MALE": ["तु ठरकी 😡👈", "तु ठरकी तेरा बाप ठरकी 😏👈", "तु है ठरकी मैं तो बोट हूं। 😏👈", "अबे तु है ठरकी hihihih 😁👈"],
