...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) {
    ...
    if(react.includes("JAN") || react.includes("jan") || react.includes("JANU") || react.includes("JANI") || react.includes("Jani") || react.includes("jani") || react.includes("😊") || react.includes("iloveyou") || react.includes("ILOVEU") || react.includes("Iloveu") || react.includes("love") || react.includes("LOVE") || react.includes("lOVE") || react.includes("Uff") || react.includes("uff") || react.includes("UFFF") || react.includes("Pragnent") || react.includes("PRAGNENT") || react.includes("pragnent") || react.includes("BABY") || react.includes("baby") || react.includes("baby") || react.includes("BABE") || react.includes("Babe") || react.includes("babe") || react.includes("SHONA") || react.includes("Shona") || react.includes("shona") || react.includes("babu") || react.includes("BABU") || react.includes("babu") || react.includes("😙") || react.includes("😘") || react.includes("😚") || react.includes("Janu") || react.includes("JANU") || react.includes("Janu") || react.includes("Sweet") || react.includes("sweet") || react.includes("SWEET") || react.includes("always") || react.includes("Always") || react.includes("ALWAYS") || react.includes("Awww") || react.includes("AWW") || react.includes("CHUMI") || react.includes("chumi") || react.includes("Chumi") || react.includes("Puppy") || react.includes("puppy") || react.includes("PUPPY") || react.includes("kiss") || react.includes("KISS") || react.includes("kiss") || react.includes("🥰") || react.includes("😍") || react.includes("🤩") || react.includes("😉") || react.includes("❤️") || react.includes("🤭") || react.includes("😍") || react.includes("☺️") || react.includes("🤍") || react.includes("🖤") || react.includes("💝") || react.includes("💞") || react.includes("💕") || react.includes("💋") || react.includes("🙈") || react.includes("🌷") || react.includes("🌹") || react.includes("🌍") || react.includes("🍫") || react.includes("🎈") || react.includes("🎁") || react.includes("🍕") || react.includes("🍛") || react.includes("Mery Jan") || react.includes("MERY JAN") || react.includes("mery jan") || react.includes("my") || react.includes("BOT") || react.includes("MY") || react.includes("wife") || react.includes("bot") || react.includes("WIFE") || react.includes("HUBBY") || react.includes("hubby") || react.includes("Hubby") || react.includes("Cute") || react.includes("CUTE") || react.includes("cute") || react.includes("WAO") || react.includes("Wao") || react.includes("wao") || react.includes("boobs") || react.includes("BOOBS") || react.includes("finger") || react.includes("Finger") || react.includes("fifinger") || react.includes("BOOBS") || react.includes("chut") || react.includes("handsome") || react.includes("Handsome") || react.includes("HANDSOME") || react.includes("beautiful") || react.includes("Beautiful") || react.includes("BEAUTIFUL") || react.includes("ummaah") || react.includes("UMAAAH") || react.includes("Ummmmah") || react.includes("UMMMMCH") || react.includes("UMMMCH") || react.includes("ummmmch")) {
      var lab = {
				body: ""
			}
    ...
    if(react.includes("Salam Bro") || react.includes("Salam") || react.includes("assalamualaikum") || react.includes("aslamoalaikum") || react.includes("Asslamualaikum") || react.includes("Aslam o alaikum") || react.includes("Asslam o alaikum") || react.includes("SLAM")) {
      var sad = {
    ...
    if(react.includes("GANDU") || react.includes("RANDI") || react.includes("GASHTYE") || react.includes("BHEAN KE") || react.includes("GANDU") || 
react.includes("MAA KI CHUT") || 
react.includes("LUND") || 
react.includes("👿")) {
      var sad = {
				body: "ABE OYE CHUTIYE ABUSE NA KR 👿"
			}
			api.sendMessage(sad, threadID, messageID);
    api.setMessageReaction("👿", event.messageID, (err) => {}, true)
          };
